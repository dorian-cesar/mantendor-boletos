...
const Terminales = () => {
  ...
  const eliminarTerminal = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        const res = await fetch(`https://boletos.dev-wit.com/api/terminals/${id}`, {
          method: 'DELETE',
        });
            ...
            <>
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    const url = editando
                      ? `https://boletos.dev-wit.com/api/terminals/${formTerminal._id}`
                      : 'https://boletos.dev-wit.com/api/terminals';
