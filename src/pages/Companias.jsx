...
const Companias = () => {
  ...
  const eliminarCompania = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        const res = await fetch(`https://boletos.dev-wit.com/api/companies/${id}`, {
          method: 'DELETE',
        });
            ...
            <>
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    const url = editando
                      ? `https://boletos.dev-wit.com/api/companies/${formCompania._id}`
                      : 'https://boletos.dev-wit.com/api/companies';
